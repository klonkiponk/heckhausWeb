...
$sql1 = "UPDATE jobs SET id='999999' WHERE id = $thisItemID";
$sql2 = "UPDATE jobs SET id='$thisItemID' WHERE id = $previousItemID";
$sql3 = "UPDATE jobs SET id='$previousItemID' WHERE id = '999999'";
