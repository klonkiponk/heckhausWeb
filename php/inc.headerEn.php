		...
		<ul class="nav navbar-nav">			
			...
			<li class="dropdown">
				...
				<ul class="dropdown-menu">
					...
					<li><a href="/<?php echo $lang; ?>/we/profile/" data-link="#weProfile">Profile</a></li>
					<li><a href="/<?php echo $lang; ?>/we/team/" data-link="#weTeam">Team</a></li>
					<li><a href="/<?php echo $lang; ?>/we/art/" data-link="#weArt">Art</a></li>
					<li><a href="/<?php echo $lang; ?>/we/press/" data-link="#wePress">Press
					</a></li>
					<li><a href="/<?php echo $lang; ?>/we/contact/" data-link="#weContact">Contact</a></li>
				</ul>
			</li>	
			<?php //WORK SECTION ?>
			<li class="dropdown">
