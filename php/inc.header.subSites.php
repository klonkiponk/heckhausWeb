		...
		<ul class="nav navbar-nav">
			...
			<li class="dropdown">
				...
				<ul class="dropdown-menu">
					<li><a href="<?php echo SERVER; ?>/<?php echo $_GET['lang']?>/index.php?id=jumbotronWe&lang=<?php echo $_GET['lang']?>">Home / News</a></li>
					<li><a href="<?php echo SERVER; ?>/<?php echo $_GET['lang']?>/index.php?id=weProfile&lang=<?php echo $_GET['lang']?>">Profil</a></li>
					...
					<li><a href="<?php echo SERVER; ?>/<?php echo $_GET['lang']?>/index.php?id=wePress&lang=<?php echo $_GET['lang']?>">Presse</a></li>
					<li><a href="<?php echo SERVER; ?>/<?php echo $_GET['lang']?>/index.php?id=weContact&lang=<?php echo $_GET['lang']?>">Kontakt</a></li>
				</ul>
			</li>	
			<?php //WORK SECTION ?>
			<li class="dropdown">
				...
				<ul class="dropdown-menu">
					<li><a href="<?php echo SERVER; ?>/<?php echo $_GET['lang']?>/index.php?id=jumbotronWork&lang=<?php echo $_GET['lang']?>">Home / News</a></li>
					<li><a href="<?php echo SERVER; ?>/<?php echo $_GET['lang']?>/index.php?id=workBestOf&lang=<?php echo $_GET['lang']?>">Best of ...</a></li>
					<li><a href="<?php echo SERVER; ?>/<?php echo $_GET['lang']?>/index.php?id=workLadenbau&lang=<?php echo $_GET['lang']?>">Ladenbau</a></li>
					...
					<li><a href="<?php echo SERVER; ?>/<?php echo $_GET['lang']?>/index.php?id=workDisplay&lang=<?php echo $_GET['lang']?>">Display / POS</a></li>
