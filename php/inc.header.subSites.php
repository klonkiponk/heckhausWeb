<nav class="navbar navbar-fixed-top" role="navigation">
	<div class="container">
		<div class="navbar-header pull-right">
			<a class="navbar-brand" href="http://www.heckhaus.de"><img alt="heckhaus.de" title="Logo der Firma Heckhaus" src="<?php echo SERVER;?>/img/logo.png"></a>
		</div>		
		<ul class="nav navbar-nav">
			...
			<li class="dropdown">
				...
				<ul class="dropdown-menu">
					...
					<li><a href="<?php echo SERVER; ?>/<?php echo $lang;?>/index.php?id=workShowroom">Showroom</a></li>

					<li><a href="<?php echo SERVER; ?>/<?php echo $lang;?>/index.php?id=workGraphics">Graphics & Window-Dressing</a></li>
					<li><a href="<?php echo SERVER; ?>/<?php echo $lang;?>/index.php?id=workDisplay">Display / POS</a></li>
					<li><a href="<?php echo SERVER; ?>/<?php echo $lang;?>/index.php?id=workEvents">Messe / Event</a></li>
					<li><a href="<?php echo SERVER; ?>/<?php echo $lang;?>/index.php?id=workRetail">Shop-in-Shop / Retail</a></li>					
					<li><a href="<?php echo SERVER; ?>/<?php echo $lang;?>/index.php?id=workSetDesign">Set-Design</a></li>					
				</ul>
			</li>
			<?php //FOR YOU SECTION ?>
			<li class="dropdown">
