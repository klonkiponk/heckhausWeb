<nav class="navbar navbar-fixed-top jsNavigation" role="navigation">
	<div class="container">
		...
		<ul class="nav navbar-nav">			
			...
			<li class="dropdown">
				...
				<ul class="dropdown-menu">
					<li><a href="/<?php echo $lang; ?>/we/home/" data-link="#jumbotronWe">Profil</a></li>
					...
					<li><a href="/<?php echo $lang; ?>/we/contact/" id="contactLinkDe">Impressum</a></li>
				</ul>
			</li>	
			<?php //WORK SECTION ?>
			<li class="dropdown">
				...
				<ul class="dropdown-menu">
					<li><a href="/<?php echo $lang; ?>/work/home/" data-link="#jumbotronWork">Home</a></li>
			...
			<li class="dropdown">
				...
				<ul class="dropdown-menu">
					...
					<li><a href="/<?php echo $lang; ?>/forYou/partner/" data-link="#forYouPartner">Partner / Freunde</a></li>
		...
		<img class="callToAction" data-toggle="modal" data-target="#myModal" src="/img/callToAction_de.png">				
