...
<script type="text/javascript" src="<?php echo SERVER ?>/js/jquery.tinycarousel.min.js"></script>
<script type="text/javascript" src="<?php echo SERVER ?>/js/bootstrap.js"></script>
