			...
			<div class="row">
				<div class="col-md-12">					
					<div class="textLabelWrapper">
						<label class="textLabel" for="contactFormName">Name / Firma</label>&nbsp;
					...
					<div class="textLabelWrapper noShow">									
						...
						<label>Möchten Sie weitere Informationen über uns, ein persönliches Gespräch oder einfach nur unseren Newsletter?</label>
